    ...
    <div class="col-12 col-sm-12 col-lg-12 col-xl-12">
        ...
        <form action="<?=base_url("Clientes_controller/agregar");?>" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputName" name="nombre" placeholder="Ingresa tu nombre (Min. 2 caracteres)" pattern="[A-Za-z]+" minlength="2" autofocus required>

                <label for="inputLastName" class="font-weight-bold">Apellido</label>
                <input type="text" class="form-control" id="inputLastName" name="apellido" placeholder="Ingresa tu apellido (Min. 2 caracteres)" pattern="[A-Za-z]+" minlength="2" required>
